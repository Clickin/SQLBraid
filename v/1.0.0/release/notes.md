...
> The SQLBraid 1.0.0 GA contract and its capability and evidence boundaries.

This is SQLBraid 1.0.0 GA documentation. GA stabilizes the public contracts, not
every capability on every driver.

The [runtime and driver support matrix](/SQLBraid/v/1.0.0/reference/support.md) lists
...
[capability limitations](/SQLBraid/v/1.0.0/release/limitations.md), including Bun 1.3.14
