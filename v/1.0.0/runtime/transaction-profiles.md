...
execution runtime. See [transactions](/SQLBraid/v/1.0.0/runtime/transactions.md), [pools](/SQLBraid/v/1.0.0/runtime/direct-pools.md), and [support evidence](/SQLBraid/v/1.0.0/reference/support.md).
