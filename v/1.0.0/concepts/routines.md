...
See [SQL tags and result kinds](/SQLBraid/v/1.0.0/concepts/sql-tags.md), [streaming](/SQLBraid/v/1.0.0/runtime/streaming.md), and [diagnostics](/SQLBraid/v/1.0.0/reference/errors.md).
