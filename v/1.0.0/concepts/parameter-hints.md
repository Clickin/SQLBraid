...
support](/SQLBraid/v/1.0.0/reference/support.md) for verified driver capabilities. Oracle
...
carrier. See [routine calls](/SQLBraid/v/1.0.0/concepts/routines.md) for result ordering,
