...
Runtime에서 선택한 것과 같은 representation profile의 TypePolicy를
전달하세요. Override는 생성된 TypeScript에만 영향을 주며 parsed/native
값을 lossless하게 만들거나 container를 인증하지 않습니다.
