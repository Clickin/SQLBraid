...
See [direct connections and pools](/SQLBraid/v/1.0.0-rc.1/runtime/direct-pools.md) and [transactions](/SQLBraid/v/1.0.0-rc.1/runtime/transactions.md) for the boundary in detail.
...
matrix](/SQLBraid/v/1.0.0-rc.1/reference/support.md) records labels for the exact
