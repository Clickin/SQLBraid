...
- The documented candidate is Tedious 20.0.0 on Node 22.18.0/Linux x64. The
  [runtime and driver support matrix](/SQLBraid/v/1.0.0-rc.1/reference/support.md) records
...
contract, see [routine calls](/SQLBraid/v/1.0.0-rc.1/concepts/routines.md).
