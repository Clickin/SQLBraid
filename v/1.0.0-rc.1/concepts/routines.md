...
See [SQL tags and result kinds](/SQLBraid/v/1.0.0-rc.1/concepts/sql-tags.md), [streaming](/SQLBraid/v/1.0.0-rc.1/runtime/streaming.md), and [diagnostics](/SQLBraid/v/1.0.0-rc.1/reference/errors.md).
