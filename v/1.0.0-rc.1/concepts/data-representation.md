# Data representations and value fidelity

> Preserve database value semantics at the driver boundary, then choose application types with Standard Schema.
...
matrix](/SQLBraid/v/1.0.0-rc.1/reference/support.md) remains the evidence authority for each exact
...
See the driver setup pages and [runtime and driver support matrix](/SQLBraid/v/1.0.0-rc.1/reference/support.md)
