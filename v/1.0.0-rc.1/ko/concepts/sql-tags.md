...
> SQL을 숨기지 않고 SQLBraid 문장이 반환하는 것을 선언합니다.
...
- `db.call`은 `sql.call`용입니다. output 방향, tuple result set, 정리, 데이터베이스별 제한은 [루틴 호출](/SQLBraid/v/1.0.0-rc.1/concepts/routines.md)을 참고하세요.
