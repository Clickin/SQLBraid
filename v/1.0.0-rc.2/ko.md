...
:::tip SQLite로 시작하기
외부 서버 없이 실행되는 [5분 SQLite 빠른 시작](/SQLBraid/v/1.0.0-rc.2/getting-started/sqlite.md)으로 시작하세요. 브라우저 및 Worker 환경은 [SQLite WASM과 D1](/SQLBraid/v/1.0.0-rc.2/getting-started/sqlite-browser.md)을 참고하세요. 서비스 데이터베이스가 필요하면 [PostgreSQL](/SQLBraid/v/1.0.0-rc.2/getting-started/postgres.md), [MySQL](/SQLBraid/v/1.0.0-rc.2/getting-started/mysql.md), 또는 [MariaDB](/SQLBraid/v/1.0.0-rc.2/getting-started/mariadb.md)로 이동하세요.
:::
...
숫자 정확도](/SQLBraid/v/1.0.0-rc.2/concepts/data-representation.md)를 참고하세요. 각
...
[릴리스 노트와 제한 사항](/SQLBraid/v/1.0.0-rc.2/release/notes.md) 및
[런타임/드라이버 증거 매트릭스](/SQLBraid/v/1.0.0-rc.2/reference/support.md)를 확인하세요.
