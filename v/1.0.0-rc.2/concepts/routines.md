...
See [SQL tags and result kinds](/SQLBraid/v/1.0.0-rc.2/concepts/sql-tags.md), [streaming](/SQLBraid/v/1.0.0-rc.2/runtime/streaming.md), and [diagnostics](/SQLBraid/v/1.0.0-rc.2/reference/errors.md).
