...
support](/SQLBraid/v/1.0.0-rc.2/reference/support.md) for verified driver capabilities. Oracle
...
carrier. See [routine calls](/SQLBraid/v/1.0.0-rc.2/concepts/routines.md) for result ordering,
