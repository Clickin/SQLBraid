...
- `db.call` is for `sql.call`; see [routine calls](/SQLBraid/v/1.0.0-rc.2/concepts/routines.md) for output directions, tuple result sets, cleanup, and database-specific limits.
