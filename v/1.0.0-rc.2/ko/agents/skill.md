...
> 호환되는 코딩 에이전트에 SQLBraid 애플리케이션 개발 지침을 설치합니다.
...
드라이버와 executor 작성자는 사용자 지정 transport를 구현하기 전에 [드라이버 작성자 바인딩 가이드](/SQLBraid/v/1.0.0-rc.2/agents/driver-author.md)도 읽으세요.
