...
> 결정적인 SQL Server 파라미터 힌트와 Tedious로 SQLBraid에 연결합니다.
...
- 문서화된 후보 조합은 Node 22.18.0/Linux x64의 Tedious 20.0.0입니다.
  지원 label과 증거는 [런타임/드라이버 지원 매트릭스](/SQLBraid/v/1.0.0-rc.2/reference/support.md)가
...
증거 라벨과 현재 매트릭스는 [런타임 및 드라이버 지원](/SQLBraid/v/1.0.0-rc.2/reference/support.md)을 참고하세요.

명시적 procedure metadata와 이질적인 `sql.call` result 계약은
[루틴 호출](/SQLBraid/v/1.0.0-rc.2/concepts/routines.md)을 참고하세요.
