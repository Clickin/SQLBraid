...
> 드라이버 경계에서 데이터베이스 값 의미를 보존하고 Standard Schema로 애플리케이션 타입을 선택합니다.
...
아래는 SQLBraid의 데이터 표현 계약입니다. [지원 매트릭스](/SQLBraid/v/1.0.0-rc.2/reference/support.md)가
...
매트릭스](/SQLBraid/v/1.0.0-rc.2/reference/support.md)를 참고하세요. 증거를 알 수 없으면
