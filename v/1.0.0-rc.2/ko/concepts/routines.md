...
> 명시적인 output, return, 이질적인 result-set 계약으로 저장 프로시저 호출을 작성합니다.
...
[SQL 태그와 결과 종류](/SQLBraid/v/1.0.0-rc.2/concepts/sql-tags.md), [스트리밍](/SQLBraid/v/1.0.0-rc.2/runtime/streaming.md), [진단](/SQLBraid/v/1.0.0-rc.2/reference/errors.md)도 참고하세요.
