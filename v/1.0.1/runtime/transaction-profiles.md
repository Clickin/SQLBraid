...
execution runtime. See [transactions](/SQLBraid/v/1.0.1/runtime/transactions.md), [pools](/SQLBraid/v/1.0.1/runtime/direct-pools.md), and [support evidence](/SQLBraid/v/1.0.1/reference/support.md).
