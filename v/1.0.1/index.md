...
The [five-minute SQLite quickstart](/SQLBraid/v/1.0.1/getting-started/sqlite.md) runs without an external server. For browser and Worker resources, see [SQLite WASM and D1](/SQLBraid/v/1.0.1/getting-started/sqlite-browser.md). Move to [PostgreSQL](/SQLBraid/v/1.0.1/getting-started/postgres.md), [MySQL](/SQLBraid/v/1.0.1/getting-started/mysql.md), or [MariaDB](/SQLBraid/v/1.0.1/getting-started/mariadb.md) when you need a service database.
:::
...
numeric fidelity](/SQLBraid/v/1.0.1/concepts/data-representation.md). Driver profiles
...
[runtime and driver support matrix](/SQLBraid/v/1.0.1/reference/support.md) for the exact
feature set of your database, driver, and runtime tuple.

See [release notes and limitations](/SQLBraid/v/1.0.1/release/notes.md) for details.
