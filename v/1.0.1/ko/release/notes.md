...
지원 여부는 [런타임/드라이버 지원 매트릭스](/SQLBraid/v/1.0.1/reference/support.md)에 기록된 데이터베이스, 드라이버, 프로필, 런타임 조합을 기준으로 합니다.
...
[Capability 제한 사항](/SQLBraid/v/1.0.1/release/limitations.md)도 참고하세요.
