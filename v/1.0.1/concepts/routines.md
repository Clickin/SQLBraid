...
See [SQL tags and result kinds](/SQLBraid/v/1.0.1/concepts/sql-tags.md), [streaming](/SQLBraid/v/1.0.1/runtime/streaming.md), and [diagnostics](/SQLBraid/v/1.0.1/reference/errors.md).
