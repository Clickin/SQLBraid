...
The [runtime and driver support matrix](/SQLBraid/v/1.0.1/reference/support.md) lists
...
[capability limitations](/SQLBraid/v/1.0.1/release/limitations.md), including Bun 1.3.14
