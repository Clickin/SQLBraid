...
Driver and executor authors should also read the [driver-author binding guide](/SQLBraid/v/1.0.1/agents/driver-author.md) before implementing a custom transport.
