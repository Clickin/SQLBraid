...
for (const name of ["@sqlbraid/language-server", "@sqlbraid/compiler", "@sqlbraid/core", "@sqlbraid/metadata", "@sqlbraid/tooling"]) {
...
const server = spawn(process.execPath, [join(consumer, "node_modules/@sqlbraid/language-server/dist/cli.js")], { cwd: consumer, stdio: "pipe" });
...
try {
  ...
  await new Promise((resolveExit, rejectExit) => {
    ...
    server.once("close", () => { clearTimeout(timer); resolveExit(); });
  });
