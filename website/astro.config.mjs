...
const configuredBase =
  process.env.SQLBRAID_DOCS_BASE?.trim() ||
  (channel === "release" && version ? `${publicRoot}/v/${version}` : `${publicRoot}/latest`);
    ...
    starlight({
      ...
      sidebar: [
        { label: "Interactive preview", translations: { ko: "인터랙티브 미리보기" }, link: "/interactive-preview/" },
        {
          ...
          items: [
            {
              label: "Five-minute SQLite",
              translations: { ko: "5분 SQLite 시작하기" },
            ...
            {
              label: "Browser SQLite and D1",
              translations: { ko: "브라우저 SQLite와 D1" },
              link: "/getting-started/sqlite-browser/",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Parameter type hints",
              translations: { ko: "매개변수 타입 힌트" },
              link: "/concepts/parameter-hints/",
            },
            { label: "Dynamic @braid", translations: { ko: "동적 @braid" }, link: "/concepts/dynamic-braid/" },
            {
              label: "Structural SQL fragments",
              translations: { ko: "구조적 SQL 조각" },
              link: "/concepts/structural-fragments/",
            },
            ...
            { label: "Homogeneous bulk DML", translations: { ko: "동종 bulk DML" }, link: "/concepts/bulk/" },
            {
              ...
              translations: { ko: "데이터 표현" },
              link: "/concepts/data-representation/",
            },
            {
              label: "Standard Schema mapping",
              translations: { ko: "Standard Schema 매핑" },
              link: "/concepts/result-mapping/",
            },
          ],
        },
        {
          ...
          items: [
            {
              label: "Direct connections and pools",
              translations: { ko: "직접 연결과 풀" },
              link: "/runtime/direct-pools/",
            },
            {
              label: "Transactions and savepoints",
              translations: { ko: "트랜잭션과 세이브포인트" },
              link: "/runtime/transactions/",
            },
            ...
            { label: "Execution observers", translations: { ko: "실행 옵저버" }, link: "/runtime/observers/" },
            {
              ...
              translations: { ko: "OpenTelemetry 통합" },
              link: "/runtime/opentelemetry/",
            },
            {
              label: "Future transaction profiles",
              translations: { ko: "향후 트랜잭션 프로필" },
              link: "/runtime/transaction-profiles/",
            },
          ],
        },
        {
          label: "Metadata and codegen",
          translations: { ko: "메타데이터와 코드 생성" },
          items: [
            {
              label: "Inspectors and snapshots",
              translations: { ko: "인스펙터와 스냅샷" },
              link: "/metadata/inspectors/",
            },
            { label: "Codegen configuration", translations: { ko: "코드 생성 설정" }, link: "/metadata/config/" },
            {
              label: "Row / Insert / Update models",
              translations: { ko: "Row / Insert / Update 모델" },
              link: "/metadata/models/",
            },
        ...
        {
          label: "Agents and editors",
          translations: { ko: "에이전트와 에디터" },
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Runtime and driver support",
              translations: { ko: "런타임과 드라이버 지원" },
              link: "/reference/support/",
            },
            {
              label: "Diagnostics and error codes",
              translations: { ko: "진단과 오류 코드" },
