---
title: Vite 통합
description: TypeScript와 TSX 변환을 가로채지 않고 Vite 8에서 SQLBraid 보호 템플릿을 lowering합니다.
---
...
직접 compiler 통합이 필요하면 `@sqlbraid/vite`가 `transformSource(source, filename, options?)`를 다시 내보냅니다. 주변 TypeScript 변환은 다른 bundler가 소유할 때만 사용하세요. [동적 템플릿](/SQLBraid/concepts/dynamic-braid/), [SQL 태그](/SQLBraid/concepts/sql-tags/), [Vite package README](https://github.com/Clickin/SQLBraid/tree/main/packages/vite)도 참고하세요.
