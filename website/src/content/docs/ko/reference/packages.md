...
패키지는 16개입니다. 스코프가 있는 런타임/도구 패키지 15개와 비스코프 CLI 편의 패키지 1개입니다. 런타임 패키지는 메타데이터, codegen, compiler, editor 의존성을 가져오지 않습니다. tooling 패키지는 개발/빌드 환경에만 설치하세요. Oracle 및 SQL Server 드라이버 의존성은 portable root에서 제외됩니다.
