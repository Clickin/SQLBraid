...
The PV17 value-fidelity migration is pending its final exact-SHA Runtime, Docs
and Release dry-run gates. Historical PV16 SQLite evidence is retained in the
release records; it does not certify the PV17 contract or npm publication.
:::
