...
매트릭스](/SQLBraid/latest/reference/support.md)가 기록한 정확한 database, driver,
...
[릴리스 노트와 제한 사항](/SQLBraid/latest/release/notes.md) 및
[런타임/드라이버 증거 매트릭스](/SQLBraid/latest/reference/support.md)를 확인하세요.
