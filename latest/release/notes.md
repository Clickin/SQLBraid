...
The [runtime and driver support matrix](/SQLBraid/latest/reference/support.md) lists
...
[capability limitations](/SQLBraid/latest/release/limitations.md), including Bun 1.3.14
