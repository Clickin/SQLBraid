...
> 기본 TypeScript 지원을 대체하지 않고 SQLBraid의 얇은 TypeScript 클라이언트를 사용합니다.
...
확장에 의미 엔진은 없습니다. VSIX에는 버전 검사가 포함된 일치하는 `0.1.0` server/CLI 의존성이 들어 있으며 전역 또는 워크스페이스 서버를 조용히 선택하지 않습니다.
