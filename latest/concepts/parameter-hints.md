...
support](/SQLBraid/latest/reference/support.md) for verified driver capabilities. Oracle
...
carrier. See [routine calls](/SQLBraid/latest/concepts/routines.md) for result ordering,
