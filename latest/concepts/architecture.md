...
For the full contributor-oriented walkthrough and invariants, see the repository's [English mental model](https://github.com/Clickin/SQLBraid/blob/main/docs/mental-model.md). Driver implementers should also read the [driver-author guide](/SQLBraid/latest/agents/driver-author.md).
