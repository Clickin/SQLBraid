...
const allPatterns = [
  ...
  /^(?:scripts\/(?:certification|ci-plan|merge-vitest-results|runtime-portability|runtime-compatibility-smoke|validate-contract-matrix|validate-runtime-compatibility|validate-runtime-floor)\.mjs)$/u,
