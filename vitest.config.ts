...
const sourceAliases = {
  ...
  "@sqlbraid/sqlite/better-sqlite3": resolve("packages/sqlite/src/better-sqlite3.ts"),
  "@sqlbraid/sqlite/libsql": resolve("packages/sqlite/src/libsql.ts"),
  ...
  "sqlbraid/better-sqlite3": resolve("packages/sqlbraid/src/better-sqlite3.ts"),
  "sqlbraid/libsql": resolve("packages/sqlbraid/src/libsql.ts"),
