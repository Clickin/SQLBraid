...
export interface Location { readonly uri: string; readonly range: { readonly start: Position; readonly end: Position } }
export interface SourceDocument { readonly fileName: string; readonly sourceText: string; readonly version?: number }
...
export interface HoverResult { readonly contents: string; readonly range: SourceRange }
export interface CompletionItem { readonly label: string; readonly kind: "relation" | "column" | "routine"; readonly detail?: string }
export interface QuerySymbol { readonly name: string; readonly detail: string; readonly range: SourceRange; readonly selectionRange: SourceRange }
export interface WorkspaceSymbol { readonly name: string; readonly kind: "relation" | "routine" | "model"; readonly location: Location; readonly detail?: string }
export interface SignatureResult { readonly label: string; readonly parameters: readonly string[]; readonly activeParameter: number }
...
export interface WorkspaceOptions extends LanguageServiceOptions { readonly rootPath: string; readonly configPath?: string }
