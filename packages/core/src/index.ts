...
/** Data-only authoring identity shared by compiler and tooling discovery. */
...
export const AUTHORING_MODULE_CATALOG: readonly AuthoringModuleCatalogEntry[] = Object.freeze([
  ...
  { moduleSpecifier: "@sqlbraid/sqlite/better-sqlite3", dialectId: "sqlite", helperFamily: "template" },
  { moduleSpecifier: "@sqlbraid/sqlite/libsql", dialectId: "sqlite", helperFamily: "template" },
